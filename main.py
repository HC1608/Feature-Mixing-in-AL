...
def supervised_learning(args):
    ...
    train_parser.add_argument('--n_epoch', type=int, default=100)#changed from 200 
    train_parser.add_argument('--n_early_stopping', type=int, default=100)#
    ...
    train_parser.add_argument('--lr_T_0', type=int, default=100)
